...
var medicines = []model.Medicine{
	{
		HealthcenterID: 1,
		Type:           "Tablet",
		Merk:           "Sanmol 500 mg 4 Tablet",
		Name:           "Paracetamol tab 500 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Sirup",
		Merk:           "Sanmol Sirup 60 ml",
		Name:           "Paracetamol sir 120 mg/5 ml",
		Unit:           "Botol",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Tablet",
		Merk:           "Cerini 10 mg 10 Tablet",
		Name:           "Cetrizine tab 10 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Sirup",
		Merk:           "Cerini Sirup 60 ml",
		Name:           "Cetrizine sir 5 mg/5 ml",
		Unit:           "Botol",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Tablet",
		Merk:           "Amoxsan 250 mg 10 Kapsul",
		Name:           "Amoxicillin tab 250 mgd",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Tablet",
		Merk:           "Amoxsan 500 mg 10 Kapsul",
		Name:           "Amoxicillin tab 500 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Sirup",
		Merk:           "Amoxsan 125 mg/5 ml Sirup Kering 60 ml",
		Name:           "Amoxicillin sir kering 125 mg/5 ml",
		Unit:           "Botol",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Sirup",
		Merk:           "Amoxsan 250 mg/5 ml Sirup Kering 60 ml",
		Name:           "Amoxicillin sir kering 250 mg/5 ml",
		Unit:           "Botol",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Kapsul",
		Merk:           "Lansoprazole Hexpharm 30 mg 10 Kapsul",
		Name:           "Lansoprazole kaps 30 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Kapsul",
		Merk:           "Omeprazole Hexpharm 20 mg 10 Kapsul",
		Name:           "Omeprazole kaps 20 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Tablet",
		Merk:           "Ranitidine Hexpharm 150 mg 10 Tablet",
		Name:           "Ranitidine tab 150 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Kaplet",
		Merk:           "Cefixime Hexpharm 100 mg 10 Kaplet",
		Name:           "Cefixime tab sal selaput 100 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Kaplet",
		Merk:           "Cefixime Hexpharm 200 mg 10 Kaplet",
		Name:           "Cefixime tab sal selaput 200 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Sirup",
		Merk:           "Cefixime Pharma 100 mg/5 ml Sirup Kering 30 ml",
		Name:           "Cefixime sir 100 mg/5 ml",
		Unit:           "Botol",
		IsActive:       true,
	},
	{
		HealthcenterID: 1,
		Type:           "Tablet",
		Merk:           "Imodium 2 mg 10 Tablet",
		Name:           "Loperamide tab sal selaput 2 mg",
		Unit:           "Strip",
		IsActive:       true,
	},
	//
